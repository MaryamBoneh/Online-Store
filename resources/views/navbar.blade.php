    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a class="text-body mr-3" href="">درباره ما</a>
                    <a class="text-body mr-3" href="">تماس با ما</a>
                    <a class="text-body mr-3" href="">راهنما</a>
                    <a class="text-body mr-3" href="">سوالات متداول</a>
                    <a class="text-body mr-3" href="">ورود به سایت</a>
                    <a class="text-body mr-3" href="">ثبت‌نام</a>
                </div>
            </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-left">
                <p class="m-0">پشتیبانی مشتریان</p>
                <h5 class="m-0">0985136667778</h5>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between bg-primary w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                    <h6 class="text-dark m-0"><i class="fa fa-bars mx-2"></i>دسته‌بندی محصولات</h6>
