<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand text-center m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        <img src="../img/logo/logo-black.png" class="navbar-brand-img h-100" alt="main_logo">
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="/admin/products">
            ...
            <span class="nav-link-text me-1">کالاها</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/admin/cities">
            ...
            <span class="nav-link-text me-1">شهرها</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/admin/comments">
            ...
            <span class="nav-link-text me-1">کامنت ها</span>
          </a>
        </li>
      </ul>
    </div>
